...
public class Main extends Application {
    ...
    public void start(Stage primaryStage) throws Exception {
        UserDBRepository userRepository = new UserDBRepository("jdbc:postgresql://localhost:5432/SocialNetwork", "postgres", "wndrlstm8", new UserValidator());
        userService = new UserService(userRepository);
        FriendshipDBRepository friendshipRepository = new FriendshipDBRepository("jdbc:postgresql://localhost:5432/SocialNetwork", "postgres", "wndrlstm8", new FriendshipValidator());
        friendshipService = new FriendshipService(friendshipRepository);
        MessageDBRepository messageRepository = new MessageDBRepository("jdbc:postgresql://localhost:5432/SocialNetwork", "postgres", "wndrlstm8", new MessageValidator());
        messageService = new MessageService(messageRepository);
        EventDBRepository eventDBRepository = new EventDBRepository("jdbc:postgresql://localhost:5432/SocialNetwork", "postgres", "wndrlstm8", new EventValidator());
